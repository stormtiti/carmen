...
//  ROS_INFO("stereo matched points: %d", matches_filtered.size());
//  std::cout<<"stereo matched points: "<<matches_filtered.size()<<std::endl;
  ...
  kp_.clear();
  kp_ = matched_kp_l;
//  ROS_INFO("Num of final features: %d ", kp_.size());
